      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-12 max-w-6xl mx-auto">
          ...
          <CardFlip
            ...
            description="Leverage the power of Arbitrum’s decentralized blockchain to deliver automated, trustless flight delay insurance with multi-interval payouts, removing bureaucracy and enabling instant user-friendly protection."
            features={["Arbitrum Powered", "Automated Payouts", "Trustless System", "User-Friendly"]}
